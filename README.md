...
=== Shopp to WooCommerce Migration Tool ===
Version: 2.4.1
Developed by: LitExtension

Download: https://litextension.com/woocommerce-migration-tool/shopp-to-woocommerce.html

== Description: Shopp to WooCommerce Migration Tool allows you to migrate your products, orders, customers, passwords and other data from Shopp to WooCommerce automatically.
